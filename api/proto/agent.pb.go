...
type RegisterResponse struct {
	...
	HmacSecret    []byte                 `protobuf:"bytes,5,opt,name=hmac_secret,json=hmacSecret,proto3" json:"hmac_secret,omitempty"`          // HMAC secret for re-authentication
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterResponse) GetHmacSecret() []byte {
	if x != nil {
		return x.HmacSecret
	}
	return nil
...
const file_api_proto_agent_proto_rawDesc = "" +
	...
	"\fmemory_bytes\x18\x04 \x01(\x03R\vmemoryBytes\"\xac\x01\n" +
	"\x10RegisterResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12 \n" +
	"\vcertificate\x18\x03 \x01(\fR\vcertificate\x12%\n" +
	"\x0eca_certificate\x18\x04 \x01(\fR\rcaCertificate\x12\x1f\n" +
	"\vhmac_secret\x18\x05 \x01(\fR\n" +
	"hmacSecret\"\x86\x02\n" +
