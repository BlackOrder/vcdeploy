...
func (v *HostKeyVerifier) ExportToKnownHostsFile(ctx context.Context, filepath string, trustedOnly bool) error {
	...
	// This is a simplified export - a full implementation would iterate all keys from store
	// For now, this creates an empty file as a placeholder for the API
...
func (e *KnownHostsExporter) ExportAll(ctx context.Context, filePath string) error {
	...
	// Note: Full implementation would list all hosts from store and export
	// This is the API structure - actual implementation depends on store interface
