...
func (db *DB) CreateHealthCheckConfig(ctx context.Context, config *HealthCheckConfig) error {
	...
	_, err := db.conn.ExecContext(ctx, `
		...
		VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
	`, config.ID, config.ProjectID, config.Name, config.URL, config.Method, config.ExpectedStatus, config.TimeoutSeconds,
...
func (db *DB) GetHealthCheckConfig(ctx context.Context, id string) (*HealthCheckConfig, error) {
...
func (db *DB) GetHealthCheckConfigForProject(ctx context.Context, projectID string) (*HealthCheckConfig, error) {
...
func (db *DB) DeleteHealthCheckConfig(ctx context.Context, id string) error {
